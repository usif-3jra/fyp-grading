...
<table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 4px 24px rgba(0,0,0,.08);">
  ...
  <tr><td style="padding:32px 40px;color:#2d2d2d;font-size:15px;line-height:1.7;">
    ...
    <p style="margin:0 0 28px;color:#6b7280;font-size:13px;">For security purposes, this password has been auto-generated by the system. You are strongly advised to change it upon your first login.</p>
    <table cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
      <tr>
        <td style="padding-right:12px;"><a href="${APP_URL}" style="display:inline-block;background:#0a1f44;color:#fff;text-decoration:none;padding:13px 24px;border-radius:8px;font-size:14px;font-weight:700;">Open FYP Grading System</a></td>
        <td><a href="https://baudom-my.sharepoint.com/:b:/g/personal/yousef_ajrah_bau_edu_lb/IQA0FxBsdn1JTbKFp9Hb_RRMAaH-tzBurxrjb6gd-c6AvyU?e=K5B6xq" style="display:inline-block;background:#fff;color:#0a1f44;text-decoration:none;padding:12px 24px;border-radius:8px;font-size:14px;font-weight:700;border:2px solid #0a1f44;">FYP 1 &amp; 2 Rubrics</a></td>
      </tr>
    </table>
    <p style="margin:0 0 8px;">We look forward to your valued contributions to this year's Final Year Projects. Should you require any assistance, please do not hesitate to reach out to the department administration.</p>
